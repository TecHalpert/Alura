...
// Parte de diagrama mostrando uma tabela com 3 linhas.
// A primeira linha contém a informação “User”, a segunda linha contém as informações “nome: string, email: string, nascimento: date, role: string, ativo: bool”,
// a terceira linha contém as informações “constructor(), exibirInfos()”.
...
// No dia a dia de desenvolvimento é muito comum precisarmos utilizar a informação da data e hora para realizar alguma tarefa ou, especialmente, lidar com dados.
// No entanto, em JavaScript, essa mesma informação pode assumir diferentes tipos.
...
// Em outro cenário, suponhamos que você decida utilizar a mesma variável dataEHora para guardar a informação da data mas,
// diferentemente do primeiro caso onde você chamou apenas o método Date() para recuperar a informação, você agora crie uma instância do objeto Date.
